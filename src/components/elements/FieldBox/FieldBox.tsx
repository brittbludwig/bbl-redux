...
const FieldBox = ({ fieldText = '', section }: FieldBoxProps) => {
  ...
  return (
    <div className="relative w-full lg:min-w-[16rem] bg-black/10 backdrop-blur-sm rounded-xl border border-white/20 p-6 shadow-lg">
      {fieldText && (
        <p className="text-white/80 text-base leading-relaxed">{fieldText}</p>
      )}
      <div className="absolute -bottom-8 left-0 w-full lg:-bottom-5 lg:left-[50%] lg:w-auto">
