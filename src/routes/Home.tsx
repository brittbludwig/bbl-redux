import { Bubbles, Navigation, Section1, Section2, Section3, Section4, Section5, Section6, Section7, Stars } from '$components';
    ...
    <div className="relative w-full min-h-screen">
      ...
      <Bubbles>
        ...
        <Section7
          ...
          sectionContent={content[6].content as string[]}
